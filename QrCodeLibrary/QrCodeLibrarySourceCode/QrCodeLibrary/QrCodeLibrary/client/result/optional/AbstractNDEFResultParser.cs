...
namespace QrCodeLibrary.client.result.optional
{
	...
	abstract class AbstractNDEFResultParser:ResultParser
	{
		...
		internal static System.String bytesToString(sbyte[] bytes, int offset, int length, System.String encoding)
		{
			try
			{
                ...
                var array = SupportClass.ToByteArray(bytes);
                ...
                tempStr = System.Text.Encoding.GetEncoding(encoding).GetString(array, 0, array.Length);
