...
using QrCodeLibrary.common.reedsolomon;
using QrCodeLibrary.qrcode.decoder;
using Version = QrCodeLibrary.qrcode.decoder.Version;

namespace QrCodeLibrary.qrcode.encoder
{
