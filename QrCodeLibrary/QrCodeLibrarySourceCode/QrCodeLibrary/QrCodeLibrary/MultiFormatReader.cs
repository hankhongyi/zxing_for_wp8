...
using QrCodeLibrary.datamatrix;
using QrCodeLibrary.oned;
using QrCodeLibrary.pdf417;
	...
	public sealed class MultiFormatReader : Reader
	{
        ...
        public System.Collections.Generic.Dictionary<Object, Object> Hints
		{
			set
			{
				...
				var formats = value == null ? null:(List<BarcodeFormat>) value[DecodeHintType.POSSIBLE_FORMATS];
