...
namespace QrCodeLibrary.multi
{
	...
	public sealed class GenericMultipleBarcodeReader : MultipleBarcodeReader
	{
        ...
        private void doDecodeMultiple(BinaryBitmap image, System.Collections.Generic.Dictionary<Object, Object> hints, List<Result> results, int xOffset, int yOffset)
		{
			Result result = null;
			try
			{
